...
def main():
    ...
    xauth_path = os.path.join(tempfile.gettempdir(), f'.{os.environ["USER"]}_docker.xauth')

    if os.path.isdir(xauth_path):
        os.system('rm -rf ' + xauth_path)
    ...
    cookie_path = os.path.join(tempfile.gettempdir(), f'.{os.environ["USER"]}_myx11cookie')
